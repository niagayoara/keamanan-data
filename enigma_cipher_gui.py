...
root.configure(bg='#F8BBD0')  # Set soft pink background

# Input text
input_label = tk.Label(root, text="Input Text:", bg='#F8BBD0', fg='#4B0082')
input_label.grid(row=0, column=0, padx=5, pady=5)
input_entry = tk.Entry(root, width=40, bg='#F8F8FF', fg='#4B0082')
input_entry.grid(row=0, column=1, padx=5, pady=5)

# Rotor positions
rotor1_label = tk.Label(root, text="Rotor 1 Position:", bg='#F8BBD0', fg='#4B0082')
rotor1_label.grid(row=1, column=0, padx=5, pady=5)
rotor1_entry = tk.Entry(root, width=5, bg='#F8F8FF', fg='#4B0082')
rotor1_entry.grid(row=1, column=1, sticky='w', padx=5, pady=5)
rotor1_entry.insert(0, "0")

rotor2_label = tk.Label(root, text="Rotor 2 Position:", bg='#F8BBD0', fg='#4B0082')
rotor2_label.grid(row=2, column=0, padx=5, pady=5)
rotor2_entry = tk.Entry(root, width=5, bg='#F8F8FF', fg='#4B0082')
rotor2_entry.grid(row=2, column=1, sticky='w', padx=5, pady=5)
rotor2_entry.insert(0, "0")

rotor3_label = tk.Label(root, text="Rotor 3 Position:", bg='#F8BBD0', fg='#4B0082')
rotor3_label.grid(row=3, column=0, padx=5, pady=5)
rotor3_entry = tk.Entry(root, width=5, bg='#F8F8FF', fg='#4B0082')
rotor3_entry.grid(row=3, column=1, sticky='w', padx=5, pady=5)
rotor3_entry.insert(0, "0")

# Output text
output_label = tk.Label(root, text="Output Text:", bg='#F8BBD0', fg='#4B0082')
output_label.grid(row=4, column=0, padx=5, pady=5)
output_entry = tk.Entry(root, width=40, bg='#F8F8FF', fg='#4B0082')
output_entry.grid(row=4, column=1, padx=5, pady=5)

# Encrypt button
encrypt_button = tk.Button(root, text="Encrypt", command=encrypt_text, bg='#D8BFD8', fg='#4B0082')
